...
class VoiceProcessingJob(Base):
    ...
    user = relationship("User", back_populates="voice_jobs", lazy="select", foreign_keys=[user_id])
    voice = relationship("Voice", back_populates="processing_jobs", lazy="select", foreign_keys=[voice_id]) 